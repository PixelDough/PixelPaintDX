var snd = snd_splash;
obj_cursor_paint.color_sel = clamp(obj_cursor_paint.color_sel+1, 0, floor(sprite_get_width(object_get_sprite(obj_palette_selector.palettes[obj_palette_selector.page]))/16))
